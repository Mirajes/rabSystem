...
public class Initializer : MonoBehaviour
{
    ...
    public void RemoveInputs(GM_NewInputSystem gameMnager)
    {

    }
    public void RemoveInputs(GM_Doom gameMnager)
    {

    }
    public void RemoveInputs(GM_Tilemap gameMnager)
    {

    }
    public void RemoveInputs(GM_Advanced2D gameMnager)
    {
